...
class Ui_UserManage(object):
    def setupUi(self, UserManage):
        ...
        self.qrcode_create_user_btn = QPushButton(UserManage)
        self.qrcode_create_user_btn.setObjectName(u"qrcode_create_user_btn")

        self.horizontalLayout.addWidget(self.qrcode_create_user_btn)

        self.mobile_create_user_btn = QPushButton(UserManage)
        self.mobile_create_user_btn.setObjectName(u"mobile_create_user_btn")

        self.horizontalLayout.addWidget(self.mobile_create_user_btn)

        self.manual_create_user_btn = QPushButton(UserManage)
        self.manual_create_user_btn.setObjectName(u"manual_create_user_btn")

        self.horizontalLayout.addWidget(self.manual_create_user_btn)
        ...
        self.horizontalLayout_2.addWidget(self.toggle_select_btn)
        ...
        self.horizontalLayout_2.addWidget(self.check_login_btn)
        ...
        self.horizontalLayout_2.addWidget(self.check_comment_btn)
    ...
    def retranslateUi(self, UserManage):
        ...
        self.qrcode_create_user_btn.setText(QCoreApplication.translate("UserManage", u"\u626b\u7801\u6dfb\u52a0", None))
        self.mobile_create_user_btn.setText(QCoreApplication.translate("UserManage", u"\u624b\u673a\u53f7\u767b\u5f55", None))
        self.manual_create_user_btn.setText(QCoreApplication.translate("UserManage", u"\u624b\u52a8\u6dfb\u52a0", None))
        self.toggle_select_btn.setText(QCoreApplication.translate("UserManage", u"\u5168\u9009", None))
        self.check_login_btn.setText(QCoreApplication.translate("UserManage", u"\u767b\u5f55\u72b6\u6001\u68c0\u6d4b", None))
        self.check_comment_btn.setText(QCoreApplication.translate("UserManage", u"\u51fa\u8bc4\u72b6\u6001\u68c0\u6d4b", None))
        self.delete_user_btn.setText(QCoreApplication.translate("UserManage", u"\u5220\u9664\u9009\u4e2d", None))
    # retranslateUi
