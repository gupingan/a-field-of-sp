...
# 格式化日期和时间
def format_datetime(dt: datetime.datetime, format_='%Y-%m-%d %H:%M:%S'):
...
# 将字符串解析为日期对象
def parse_date(date_str, format_='%Y-%m-%d'):
    return datetime.datetime.strptime(date_str, format_).date()
