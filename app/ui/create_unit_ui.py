...
class Ui_CreateUnit(object):
    def setupUi(self, CreateUnit):
        ...
        self.qrcode_create_user_btn = QPushButton(CreateUnit)
        self.qrcode_create_user_btn.setObjectName(u"qrcode_create_user_btn")
        sizePolicy1.setHeightForWidth(self.qrcode_create_user_btn.sizePolicy().hasHeightForWidth())
        self.qrcode_create_user_btn.setSizePolicy(sizePolicy1)
        self.qrcode_create_user_btn.setStyleSheet(u"")

        self.horizontalLayout_4.addWidget(self.qrcode_create_user_btn)
        ...
        QWidget.setTabOrder(self.create_config_btn, self.qrcode_create_user_btn)
    ...
    def retranslateUi(self, CreateUnit):
        ...
        self.qrcode_create_user_btn.setText(QCoreApplication.translate("CreateUnit", u"\u626b\u7801\u6dfb\u52a0", None))
