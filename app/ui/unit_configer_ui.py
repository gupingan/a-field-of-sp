...
class Ui_UnitConfiger(object):
    def setupUi(self, UnitConfiger):
        ...
        self.label_2 = QLabel(UnitConfiger)
        ...
        self.label_3 = QLabel(UnitConfiger)
        self.label_3.setObjectName(u"label_3")

        self.horizontalLayout.addWidget(self.label_3)

        self.add_count_sb = QSpinBox(UnitConfiger)
        self.add_count_sb.setObjectName(u"add_count_sb")
        self.add_count_sb.setMaximum(1000)

        self.horizontalLayout.addWidget(self.add_count_sb)
    ...
    def retranslateUi(self, UnitConfiger):
        ...
        self.label_2.setText(QCoreApplication.translate("UnitConfiger", u"\u9996\u9879", None))
        self.label_3.setText(QCoreApplication.translate("UnitConfiger", u"\u589e\u91cf", None))
