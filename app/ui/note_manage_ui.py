...
class Ui_NoteManage(object):
    def setupUi(self, NoteManage):
        ...
        self.export_note_btn = QPushButton(NoteManage)
        self.export_note_btn.setObjectName(u"export_note_btn")

        self.horizontalLayout.addWidget(self.export_note_btn)
    ...
    def retranslateUi(self, NoteManage):
        ...
        self.export_note_btn.setText(QCoreApplication.translate("NoteManage", u"\u5bfc\u51fa\u7b14\u8bb0", None))
